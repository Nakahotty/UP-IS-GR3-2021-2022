...
- Представяне на водещия на курса (кой съм аз?)
- FMI 101</li>
- Обсъждане какво ще правим през часовете, въведение в курса
...
## Какво е IDE?
За да може да напишем програмите, които искаме първо ни трябва IDE или Интегрираната среда за разработка e софтуерно приложение, което предоставя цялостна среда за разработване на софтуер на програмистите. За нашите програми препоръчваме Visual Studio или Visual Studio Code! (Visual Studio Code не е IDE)

## Tutorial за VS и VS Code
Ако не си бил/а на упражнение или не си схванал/а точните стъпки за инсталация и създаване на C++ проект може да изгледаш **това видео:** 
https://www.youtube.com/watch?v=oX4N9O98NdU
...
**командите за вход/изход от конзолата са дефинирани в библиотеката <iostream.h>, която ще добавяме в началото на нашите програми**
...
*Изчаква се **въвеждане на стойност от клавиатурата** и тя се присвоява на променлива. Стойностите може да са разделени с интервал или знак за нов ред.* **cin е дефиниранa в библиотеката <iostream.h>**
...
Warning означава, че синтаксисът на езика е спазен, но е много вероятно да е допусната грешка или да предупреди за потенциална такава.
