...
## Цикли(Loops)
Да предположим, че ваш приятел ви моли да му напишете програма, която извежда първите 5 степени на числото Х. Какво ще направите? Използвайки, математическо мислене стигаме до тук:
...
Обаче, приятелят ви се е объркал. Искал е да не са 5 ами **25**. Е, в такъв случай може отново да изберете горния подход..ще отнеме цяла вечност и ще пишете едно и също много пъти, като добавяте постоянно нов множител. Да - тъпо и неефективно. Е, какво да правим тогава? Забелязваме, че е налице **повторение на един и същ оператор, докато не се наруши дадено условие.** А това показва, че имаме **цикличност** или още **цикъл**(**loop**). 
